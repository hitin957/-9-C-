...
class Game
{
    ...
    public void Main()
    {
        walls = new Walls((int)Razmer.Right, (int)Razmer.Down, '#');
        snake = new Snake((int)Razmer.Right / 2, (int)Razmer.Down / 2, 3);

        foodFactory = new FoodFactory((int)Razmer.Right, (int)Razmer.Down, '@');
